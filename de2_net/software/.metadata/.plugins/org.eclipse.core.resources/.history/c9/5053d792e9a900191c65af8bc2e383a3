...
void SSSInitialTask(void *task_data)
{
  ...
  LCD_Init();
  int sw, but;
  uint32_t volatile * volatile userhw_base = (uint32_t*) CUSTOM_0_BASE;
  ...
  int b = 0;
	while(1){
		...
		IOWR_ALTERA_AVALON_PIO_DATA(CUSTOM_0_BASE, 0x080);
		IOWR_ALTERA_AVALON_PIO_DATA(USER_HW_0_BASE, 0x8040201009);
